...
int Bar::getInt() const { return _intValue; }

void Bar::setInt(int input) { _intValue = input; }

int64_t Bar::getInt64() const { return _int64Value; }

void Bar::setInt64(int64_t input) { _int64Value = input; }
